...
curl -X PUT https://acs-STC.grc-apps.svc.ice.ge.com -d@ ./reference_application_zone-create.json -v 
...
curl -X PUT https://acs-STC.grc-apps.svc.ice.ge.com/v1/policy-set/rmd_ref_app_int -d@ ./rmd_app_policy.json -v 
-H "Authorization: Bearer <TOKEN_FROM_PREVIOUS_CMD>"
-H "Content-Type: application/json" 
...
# Admin
curl -X PUT https://acs-STC.grc-apps.svc.ice.ge.com/v1/subject/rmd_admin_1 -d@ ./rmd_admin_role_attribute.json -v 
-H "Authorization: Bearer <TOKEN_FROM_PREVIOUS_CMD>"
-H "Content-Type: application/json" 
-H "Acs-Zone-Subdomain: rmd-refapp-subdomain" 	

# Operator
curl -X PUT https://acs-STC.grc-apps.svc.ice.ge.com/v1/subject/rmd_user_1 -d@ ./rmd_operator_role_attribute.json -v 
-H "Authorization: Bearer <TOKEN_FROM_PREVIOUS_CMD>"
-H "Content-Type: application/json" 
-H "Acs-Zone-Subdomain: rmd-refapp-subdomain" 	
...
curl -X POST https://acs-STC.grc-apps.svc.ice.ge.com/v1/policy-evaluation -d@ ./dataseed_policy_evaluation.json -v 
-H "Authorization: Bearer <TOKEN_FROM_PREVIOUS_CMD>"
-H "Content-Type: application/json" 
-H "Acs-Zone-Subdomain: rmd-refapp-subdomain"
